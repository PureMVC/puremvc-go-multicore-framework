...
func TestGetInstance(t *testing.T) {
	// Test Factory Method
	var v = view.GetInstance("ViewTestKey1", func() interfaces.IView { return &view.View{Key: "ViewTestKey1"} })
...
func TestRegisterAndNotifyObserver(t *testing.T) {
	...
	var v = view.GetInstance("ViewTestKey2", func() interfaces.IView { return &view.View{Key: "ViewTestKey2"} })
...
func TestRegisterAndRetrieveMediator(t *testing.T) {
	// Get the Multiton View instance
	var v = view.GetInstance("ViewTestKey3", func() interfaces.IView { return &view.View{Key: "ViewTestKey3"} })
	...
	var m = v.RetrieveMediator(ViewTestMediator_NAME)

	// test assertions
	if m != viewTestMediator {
...
func TestHasMediator(t *testing.T) {
	// register a Mediator
	var v = view.GetInstance("ViewTestKey4", func() interfaces.IView { return &view.View{Key: "ViewTestKey4"} })
...
func TestRegisterAndRemoveMediator(t *testing.T) {
	// Get the Multiton View instance
	var v = view.GetInstance("ViewTestKey5", func() interfaces.IView { return &view.View{Key: "ViewTestKey5"} })
...
func TestOnRegisterAndOnRemove(t *testing.T) {
	// Get the Multiton View instance
	var v = view.GetInstance("ViewTestKey6", func() interfaces.IView { return &view.View{Key: "ViewTestKey6"} })
...
func TestSuccessiveRegisterAndRemoveMediator(t *testing.T) {
	// Get the Multiton View instance
	var v = view.GetInstance("ViewTestKey7", func() interfaces.IView { return &view.View{Key: "ViewTestKey7"} })
...
func TestRemoveMediatorAndSubsequentNotify(t *testing.T) {
	// Get the Multiton View instance
	var v = view.GetInstance("ViewTestKey8", func() interfaces.IView { return &view.View{Key: "ViewTestKey8"} })
...
func TestRemoveOneOfTwoMediatorsAndSubsequentNotify(t *testing.T) {
	// Get the Multiton View instance
	var v = view.GetInstance("ViewTestKey9", func() interfaces.IView { return &view.View{Key: "ViewTestKey9"} })
...
func TestMediatorReregistration(t *testing.T) {
	// Get the Multiton View instance
	var v = view.GetInstance("ViewTestKey10", func() interfaces.IView { return &view.View{Key: "ViewTestKey10"} })
...
func TestModifyObserverListDuringNotification(t *testing.T) {
	// Get the Multiton View instance
	var v = view.GetInstance("ViewTestKey11", func() interfaces.IView { return &view.View{Key: "ViewTestKey11"} })
